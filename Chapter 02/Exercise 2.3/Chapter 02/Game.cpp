...
bool Game::Initialize()
{
	...
	this->window = SDL_CreateWindow("Chapter 01", 120, 35, 1024, 768, 0);
	if (!this->window)
	{
...
void Game::LoadData()
{
	...
	TileMapComponent* tm = new TileMapComponent(temp_actor, 30);
	tm->ReadTileSet("Assets/MapLayer1.csv");

	TileMapComponent* tm2 = new TileMapComponent(temp_actor, 20);
	tm2->ReadTileSet("Assets/MapLayer2.csv");

	TileMapComponent* tm3 = new TileMapComponent(temp_actor, 10);
	tm3->ReadTileSet("Assets/MapLayer3.csv");
}
